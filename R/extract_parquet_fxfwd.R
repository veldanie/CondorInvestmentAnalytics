...
extract_parquet_fxfwd <- function(bucket_name='condor-sura-qa', file_name = 'output/series_fxfwd/series_fxfwd.parquet', to_nested_list=TRUE, colnames_fx = c('outright','premium')){
